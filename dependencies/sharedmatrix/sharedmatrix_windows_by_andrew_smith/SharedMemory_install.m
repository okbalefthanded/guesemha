...
if ~isempty(strfind(computer(),'WIN'))
    ...
    BOOST_dir = 'C:\Program Files\boost_1_65_1';
    
    BOOST_LIB_DIR = [BOOST_dir,'\lib64-msvc-11.0'];
...
% added by Okba BEKHELIFI for solving error LNK1104:
mexopts = sprintf('%s -I''%s'' ', mexopts, BOOST_LIB_DIR);
